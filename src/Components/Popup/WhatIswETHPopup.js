    ...
    return (
        <motion.div
            ...
            <div className="border-radius bg-white popup-width">
                ...
                <p className="sub-heading">The first time you convert ETH into wETH, there’s a second transaction needed to approve Starlight to access your wETH when a sale occurs. This only needs to happen once per user.</p>
                <p className="sub-heading">If you have more questions, email us at <a href="mailto:support@starlight.com"><b>support@starlight.com</b></a> or learn more about wETH at <a href="#0"><b>weth.io</b></a></p>

                <div>
                    <button className="btn btn-ping w-100">
                        Continue
                    </button>
                </div>
