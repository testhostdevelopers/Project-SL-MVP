            ...
            <motion.div
                ...
                <div className="border-radius bg-white popup-width">
                    ...
                    <div className="pt-2 pb-2 border-bottom d-flex justify-content-between bid-input">
                        ...
                        {/* <div>0.2</div> */}
                        <div className="info">
                            <a href="#0" className="nav-link dropdown-toggle" id="servicesDropdown" data-toggle="dropdown" >
                            ...
                            <div className="dropdown-menu popup-inner-dropdown-menu">
                                <ul className="menu-dropdown">
                                    <li><Link to="/">ETH</Link></li>
                                    <li><Link to="/">BTC</Link></li>
                                    <li><Link to="/">DAI</Link></li>
                                    <li><Link to="/">USDC</Link></li>
                                    <li><Link to="/">Starlight</Link></li>
                                    <li><Link to="/">ASH</Link></li>
                                    <li><Link to="/">ATRI</Link></li>
